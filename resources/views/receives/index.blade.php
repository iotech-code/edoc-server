...
<div class="col-12">
  ...
  <a class="btn btn-success " style="color: white" href="{{ route('received') }}"><i class="fa fa-book"></i> ทะเบียนรับหนังสือ </a>
  </div>

  <div class="row">
    <div id="moreSearch" class="explain-search">
      <form id="searchForm" action="{{ route('receive')}}" method="get">
        ...
        <table class="table">
          <thead>
              <tr class=" text-center">
                  ...
                  <th class="color-secondary" width="130">ผู้ส่ง</th>
                  <th class="color-secondary" width="100">เลขที่เอกสาร</th>
                  <th class="color-secondary" width="300">ชื่อเอกสาร</th>
                  <th class="color-secondary" width="130">ตู้เอกสารปลายทาง</th>
          ...
          <tbody>
            @foreach ($documents as $document)
                ...
                <tr data-id="{{ $document->id }}" data-user-id="{{ $document->cabinet_id }}">
                  <td><a class="btn btn-danger" style="color: white">รอลงรับ </td>
                  ...
                  <td> 
                      ...
                      @endif
                      @if ( $document->user_id == $user->id || $user->role_id = 1 || $user->role_id = 2)
                        <a 
                        class="btn btn-warning"
                        href="{{ route('document.edit', $document->id) }}"><img src="{{ asset("image/cabinet-edit.png") }}">
                            ลงทะเบียนรับ
                      @endif
