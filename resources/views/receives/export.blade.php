...
<div class="col-12">
  ...
  <a class="btn" href="{{ route('received') }}" style="font-size: 22px; font-weight:bold; color:forestgreen">
  ...
  <div class="row">
    <div id="moreSearch" class="pdf-search">
      <form id="searchForm" action="{{ route('pdf')}}" method="get">
